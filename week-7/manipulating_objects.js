...
// 
// Q: What tests did you have trouble passing? What did you do to make it pass? Why did that work?
// A: The only test that I had a minor issue with was adding new objects to terah's children property.
//    I solved it by using dot notation and setting the appropriate properties equal to their respective objects.
//  
// Q: How difficult was it to add and delete properties outside of the object itself?
// A: Surprisingly not difficult. I was pleasantly surprised with how easy this challenge came to me.
//    I'll take that as progress.
// 
// Q: What did you learn about manipulating objects in this challenge?
// A: I learned about deleting and adding objects to properties, creating objects and vars, and manipulating
//    variables.
// 
// __________________________________________
